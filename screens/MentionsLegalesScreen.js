        ...
        <ScrollView>
          ...
          <View style={styles.view}>
            ...
            <Text style={styles.text}>
              ...
              engageons à respecter la confidentialité et la sécurité des
              données personnelles de nos utilisateurs. Les données personnelles
              collectées via l'application Share sont utilisées uniquement dans
              le but de fournir les services offerts par l'application et ne
              seront en aucun cas vendues ou cédées à des tiers.
            </Text>
          </View>
          ...
          <View style={styles.view}>
            ...
            <Text style={styles.text}>
              ...
              clips vidéo, téléchargements numériques et compilations de
              données, est la propriété de Share et est protégé par les lois sur
              le droit d'auteur et autres lois applicables en matière de
          ...
          <View style={styles.view}>
            ...
            <Text style={styles.text}>
              ...
              l'expérience utilisateur. Les cookies sont de petits fichiers
              texte placés sur votre appareil pour aider l'application à
              analyser l'utilisation de celle-ci, à personnaliser votre
              expérience et à vous fournir des fonctionnalités améliorées.
            </Text>
          </View>
          ...
          <View style={styles.view}>
            ...
            <Text style={styles.text}>
              - Vous êtes seul responsable de l'exactitude, de l'intégralité et
              de la légalité des fichiers que vous partagez via l'application
              Share.
            </Text>
            <Text style={styles.text}>
              - Vous vous engagez à ne pas utiliser l'application Share à des
              fins illicites ou interdites par les présentes conditions.
            </Text>
            <Text style={styles.text}>
            ...
            <Text style={styles.text}>
              ...
              interprétées conformément aux lois en vigueur en France. Tout
              litige découlant de l'utilisation de l'application Share sera
              soumis à la juridiction exclusive des tribunaux d'Arras.
            </Text>
          </View>
